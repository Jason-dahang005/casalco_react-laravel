      ...
      <div className="w-full flex flex-col justify-between pt-24">
        <div className='grid md:grid-cols-4 max-w-[1000px] m-auto text-[#fff]'>
          <div className="col-span-3 flex flex-col justify-center md:items-start w-full px-2 py-8">
            <div className='border-t-2 border-casalcoOrange text-[#000] font-bold uppercase'>
              <h1 className="text-[#000] text-3xl">Welcome to CASALCO</h1>
            </div>
            ...
            <Link to="/membership" className='bg-casalcoOrange sm:w-[40%] hover:w-[60%] py-3 px-6 text-center font-semibold rounded-full hover:bg-[#fff] hover:text-[#ff3300] duration-500'>BECOME A MEMBER NOW</Link>
          </div>
        </div>
        </div>
      </div>
