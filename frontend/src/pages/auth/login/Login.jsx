        ...
        <div className='flex flex-col justify-center col-span-2'>
          <form onSubmit={submitLogin} className='max-w-[400px] w-full mx-auto px-5 rounded-lg shadow-xl'>
            ...
            <div className='flex flex-col py-2'>
              ...
              <input type="email" className='py-2 outline-none rounded-full border px-5' name='email' onChange={handleLogin} value={login.email} />
            </div>
            <div className='flex flex-col py-2'>
              <label htmlFor="" className='pl-5'>Password</label>
              <input type="password" className='py-2 outline-none rounded-full border px-5' name='password' onChange={handleLogin} value={login.password}/>
            </div>
            <div>
